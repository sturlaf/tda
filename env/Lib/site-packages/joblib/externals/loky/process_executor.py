...
class _SafeQueue(Queue):
    ...
    def _on_queue_feeder_error(self, e, obj):
        if isinstance(obj, _CallItem):
            ...
            raised_error = set_cause(raised_error, _RemoteTraceback("".join(tb)))
...
class _ExecutorManagerThread(threading.Thread):
    ...
    def join_executor_internals(self):
        ...
        mp.util.debug(
            "executor management thread clean shutdown of worker "
...
def _check_system_limits():
    ...
    if nsems_max >= 256:
        ...
        return
    _system_limited = (
        "system provides too few semaphores (%d available, "
