...
if sys.version_info[:2] >= (3, 4):
    ...
    def get_context(method=None):
        ...
        try:
            ...
            raise ValueError(
                "Unknown context '{}'. Value should be in {}.".format(
...
def set_start_method(method, force=False):
    ...
    ), "'{}' is not a valid start_method. It should be in {}".format(
        method, START_METHODS
    )
...
def _count_physical_cores():
    ...
    try:
        ...
        if cpu_count_physical < 1:
            raise ValueError("found {} physical cores < 1".format(cpu_count_physical))
