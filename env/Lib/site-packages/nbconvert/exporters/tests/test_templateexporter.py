...
class TestExporter(ExportersTestsBase):
        ...
        config = Config(
            {
                "Exporter": {
                    "preprocessors": [
                        "nbconvert.exporters.tests.cheese.CheesePreprocessor"
                    ]
                }
            }
        )
    ...
    def test_pickle(self):
        ...
        (output, resources) = executor.submit(
    ...
    def test_relative_template_name_tpl_compatibility_dot_nested(self):
        self.relative_template_test(
            os.path.join(".", "relative", "relative_template.tpl")
        )
    ...
    def test_exclude_code_cell(self):
        ...
        nb_no_code, resources_no_code = exporter_no_code.from_filename(
            self._get_notebook()
        )
    ...
    def test_exclude_input_prompt(self):
        ...
        (
            nb_no_input_prompt,
            resources_no_input_prompt,
        ) = exporter_no_input_prompt.from_filename(self._get_notebook())

        assert not resources_no_input_prompt["global_content_filter"][
            "include_input_prompt"
        ]
    ...
    def test_exclude_output_prompt(self):
        ...
        (
            nb_no_output_prompt,
            resources_no_output_prompt,
        ) = exporter_no_output_prompt.from_filename(self._get_notebook())

        assert not resources_no_output_prompt["global_content_filter"][
    ...
    def test_exclude_output_stdin(self):
        ...
        (
            nb_no_output_stdin,
            resources_no_output_stdin,
        ) = exporter_no_output_prompt.from_filename(
