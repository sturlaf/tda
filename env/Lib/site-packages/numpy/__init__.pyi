...
class dtype(Generic[_DTypeScalar_co]):
    ...
    @overload
    def __new__(
        cls, dtype: Type[str], align: bool = ..., copy: bool = ...
    ) -> dtype[str_]: ...
    @overload
    def __new__(
    ...
    def __new__(
        cls,
        dtype: _ObjectCodes | Type[ct.py_object],
        align: bool = ...,
        copy: bool = ...,
    ) -> dtype[object_]: ...
    ...
    def fields(
        ...
        Mapping[str, Union[Tuple[dtype[Any], int], Tuple[dtype[Any], int, Any]]]
    ]: ...
    @property
    def flags(self) -> int: ...
    @property
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeType, _DType_co]):
    ...
    @overload
    def __mod__(
        self: _ArrayTD64_co, other: _NestedSequence[_SupportsArray[dtype[timedelta64]]]
    ) -> NDArray[timedelta64]: ...
    @overload
    ...
    def __floordiv__(
        ...
        other: _NestedSequence[_SupportsArray[dtype[timedelta64]]],
    ) -> NDArray[int64]: ...
    @overload
    def __floordiv__(
...
class ndenumerate(Generic[_ScalarType]):
    ...
    def __new__(
        cls,
        arr: _NestedSequence[_SupportsArray[dtype[_ScalarType]]],
