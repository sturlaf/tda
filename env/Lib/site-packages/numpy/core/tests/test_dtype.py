...
class TestBuiltin:
    ...
    def test_field_order_equality(self):
        ...
        y = np.dtype({"names": ["B", "A"], "formats": ["f4", "i4"], "offsets": [4, 0]})
...
class TestPickling:
    ...
    @pytest.mark.parametrize(
        "t", [int, float, complex, np.int32, str, object, np.compat.unicode, bool]
    )
...
class TestPromotion:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (np.longdouble(np.nextafter(1.7e308, 0.0)), np.complex128),
            ...
            # Base of the double value to sidestep any rounding issues:
            (np.clongdouble(np.nextafter(1.7e308, 0.0) * 1j), np.complex128),
            # Additionally use "nextafter" so the cast can't round down:
    ...
    def test_complex_pyscalar_promote_rational(self):
        with pytest.raises(TypeError, match=r".* do not have a common DType"):
