...
def test_save(notebook):
    ...
    for link in wait_for_selector(notebook.browser, "a.item_link"):
        ...
        raise AssertionError(
            "{!r} not found in {!r}".format(escaped_name, hrefs_nonmatch)
        )
