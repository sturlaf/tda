...
mocked_gateway = patch(
    "notebook.gateway.managers.gateway_request", mock_gateway_request
)
...
class TestGateway(NotebookTestBase):
    ...
    def get_patch_env(cls):
        ...
        test_env.update(
            {
                "JUPYTER_GATEWAY_URL": TestGateway.mock_gateway_url,
    ...
    def get_argv(cls):
        ...
        argv.extend(
            [
                ...
                "--GatewayClient.http_user=" + TestGateway.mock_http_user,
            ]
        )
        return argv
    ...
    def test_gateway_class_mappings(self):
        ...
        assert (
            self.notebook.kernel_spec_manager_class.__name__
    ...
    def create_session(self, kernel_name):
        ...
        with mocked_gateway:
            ...
            self.assertEqual(
                model.get("kernel").get("name"), running_kernel.get("name")
            )
