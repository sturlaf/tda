...
class BundlerHandler(IPythonHandler):
    ...
    def get(self, path):
        ...
        try:
            ...
            raise web.HTTPError(400, "Bundler %s not enabled" % bundler_id) from e
        ...
        try:
            ...
            raise web.HTTPError(500, "Could not import bundler %s " % bundler_id) from e
...
default_handlers = [(r"/bundle/(.*)", BundlerHandler)]
