...
class BundleAPITest(NotebookTestBase):
    ...
    def test_notebook_not_found(self):
        ...
        resp = self.request(
            "GET", "bundle/fake.ipynb", params={"bundler": "fake_bundler"}
        )
    ...
    def test_bundler_not_enabled(self):
        ...
        resp = self.request(
            "GET", "bundle/testnb.ipynb", params={"bundler": "fake_bundler"}
        )
        self.assertEqual(resp.status_code, 400)
    ...
    def test_bundler_invoke(self):
        ...
        with patch("notebook.bundler.handlers.BundlerHandler.get_bundler") as mock:
            mock.return_value = {
                "module_name": "notebook.bundler.tests.test_bundler_api"
            }
            resp = self.request(
                "GET", "bundle/testnb.ipynb", params={"bundler": "stub_bundler"}
            )
