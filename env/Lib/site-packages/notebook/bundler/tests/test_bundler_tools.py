...
```""",
    ...
    def test_glob_dir(self):
        ...
        self.assertIn(
            os.path.join("resources", "empty.ipynb"),
    ...
    def test_glob_splatsplat_in_middle(self):
        ...
        self.assertIn(
            os.path.join("resources", "subdir", "test_file.txt"), globs, globs
        )
    ...
    def test_glob_splatsplat_leading(self):
        ...
        self.assertIn(
            os.path.join("resources", "another_subdir", "test_file.txt"), globs, globs
        )
    ...
    def test_copy_filelist(self):
        ...
        self.assertTrue(
            os.path.isfile(
                os.path.join(self.tmp, "resources", "another_subdir", "test_file.txt")
            )
        )
        self.assertFalse(
