...
from jupyter_core.paths import jupyter_config_dir, ENV_CONFIG_PATH, SYSTEM_CONFIG_PATH
...
class BaseExtensionApp(JupyterApp):
    ...
    def _verbose_changed(self):
        ...
        warnings.warn(
            "`verbose` traits of `{}` has been deprecated, has no effects and will be removed in notebook 5.0.".format(
                type(self).__name__
            ),
            DeprecationWarning,
        )
