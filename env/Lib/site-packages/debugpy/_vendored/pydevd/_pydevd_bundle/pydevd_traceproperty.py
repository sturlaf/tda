...
class DebugProperty(object):
    ...
    def __get__(self, obj, objtype=None):
        ...
        try:
            if (
                global_debugger is not None
                and global_debugger.disable_property_getter_trace
            ):
    ...
    def __set__(self, obj, value):
        ...
        try:
            if (
                global_debugger is not None
                and global_debugger.disable_property_setter_trace
            ):
                global_debugger.disable_tracing()
    ...
    def __delete__(self, obj):
        ...
        try:
            if (
                global_debugger is not None
                and global_debugger.disable_property_deleter_trace
            ):
                global_debugger.disable_tracing()
