...
def is_unhandled_exception(container_obj, py_db, frame, last_raise_line, raise_lines):
    ...
    if frame.f_lineno in raise_lines:
        ...
        if try_except_infos is None:
            container_obj.try_except_infos = (
                try_except_infos
        ...
        if event == "exception":
            ...
            if exc_info and arg is None:
                ...
                if container_obj is None:
                    container_obj = frame_skips_cache[
                        custom_key
            ...
            if trace is not None and hasattr(trace, "tb_next"):
                ...
                if not should_stop:
                    ...
                    if (
                        ...
                        and main_debugger.ignore_system_exit_code(value)
                    ):
                        pass
                        ...
                        for exc_break, is_user_uncaught in check_excs:
                            ...
                            if main_debugger.exclude_exception_by_filter(
                                ...
                                and not main_debugger.handle_breakpoint_condition(
                                ...
                                should_stop = False
                                if not main_debugger.apply_files_filter(
                                ...
                                if (
                                    ...
                                    and main_debugger.skip_on_exceptions_thrown_in_same_context
                                    ...
                                    exc_break.notify_on_first_raise_only
                                    and not main_debugger.skip_on_exceptions_thrown_in_same_context
                                    and not was_just_raised
                                ):
    ...
    def handle_user_exception(self, frame):
        ...
        if exc_info:
            return self._handle_exception(
                frame, "exception", exc_info[0], EXCEPTION_TYPE_USER_UNHANDLED
            )
        return False
            ...
            try:
                ...
                try:
                    ...
                    self.do_wait_suspend(
                        thread, frame, event, arg, exception_type=exception_type
                    )
                finally:
    ...
    def trace_dispatch(self, frame, event, arg):
        ...
        try:
            ...
            if (
                ...
                if event == "line":
                    ...
                    if has_exception_breakpoints:
                        should_stop, frame = self._should_stop_on_exception(
                            frame, event, arg
                        )
                        if should_stop:
                ...
                if event == "line":
                    ...
                    if (
                        ...
                        function_breakpoint_on_call_event = (
                            main_debugger.function_breakpoint_name_to_breakpoint.get(
                                frame.f_code.co_name
                            )
                        )
            ...
            if not is_exception_event:
                breakpoints_for_file = main_debugger.breakpoints.get(
                ...
                if info.pydev_state == 1:  # STATE_RUN = 1
                    ...
                    if step_cmd == -1:
                        ...
                        if main_debugger.apply_files_filter(
                            frame, frame.f_code.co_filename, True
                        ) and (
                            frame.f_back is None
                            or main_debugger.apply_files_filter(
                    ...
                    if can_skip:
                        ...
                        if (
                            can_skip
                            and main_debugger.show_return_values
            ...
            try:
                ...
                if function_breakpoint_on_call_event:
                    ...
                    plugin_manager is not None and main_debugger.has_plugin_line_breaks
                ):
                ...
                if main_debugger.show_return_values:
                    if is_return and (
                        ...
                        or (
                            ...
                            and not main_debugger.apply_files_filter(
                                frame.f_back, frame.f_back.f_code.co_filename, True
                            )
                        )
                    ):
                ...
                if stop:
                    ...
                    result = plugin_manager.suspend(
                        main_debugger, thread, frame, bp_type
                    )
                    if result:
                        frame = result
                ...
                if pydevd_dont_trace.should_trace_hook is not None:
                    if self.should_skip == -1:
                        ...
                        if not pydevd_dont_trace.should_trace_hook(
                            frame, abs_path_canonical_path_and_base[0]
                        ):
                ...
                if should_skip:
                    ...
                    if is_line:
                        if (
                            ...
                            or main_debugger.is_files_filter_enabled
                        ):
                        ...
                        if (
                            main_debugger.get_file_type(frame.f_back)
                    ...
                    if plugin_manager is not None:
                        result = plugin_manager.cmd_step_into(
                            main_debugger, frame, event, self._args, stop_info, stop
                        )
                        if result:
