        ...
        for instruction in _iter_instructions(co):
            ...
            if curr_op_name in ("SETUP_EXCEPT", "SETUP_FINALLY"):
                ...
                try_except_info.except_end_line = _get_line(
                    op_offset_to_line, instruction.argval, firstlineno, search=True
                )
            ...
            elif curr_op_name in (
                "WITH_CLEANUP_START",
                "WITH_CLEANUP",
            ):  # WITH_CLEANUP is Python 2.7, WITH_CLEANUP_START Python 3.
                stack_in_setup.append(
                    TryExceptInfo(-1, ignore=True)
                )  # Just there to be removed at END_FINALLY.
                ...
                curr_op_name == "END_FINALLY"
            ):  # The except block also ends with 'END_FINALLY'.
    ...
    def _lookahead(self):
        ...
        if next_instruction.opname == "CALL_FUNCTION":
            ...
            del self.instructions[
                delta : delta + next_instruction.argval + 2
            ]  # +2 = NAME / CALL_FUNCTION
