...
class RunInTerminalRequestArguments(BaseSchema):
    ...
    __props__ = {
        ...
        "title": {"type": "string", "description": "Optional title of the terminal."},
        "cwd": {
            "type": "string",
...
class DisconnectArguments(BaseSchema):
    ...
    def __init__(
        self, restart=None, terminateDebuggee=None, update_ids_from_dap=False, **kwargs
    ):  # noqa (update_ids_from_dap may be unused)
        """
...
class DataBreakpointInfoArguments(BaseSchema):
    ...
    def __init__(
        self, name, variablesReference=None, update_ids_from_dap=False, **kwargs
    ):  # noqa (update_ids_from_dap may be unused)
        """
...
class NextArguments(BaseSchema):
    ...
    def __init__(
        self, threadId, granularity=None, update_ids_from_dap=False, **kwargs
    ):  # noqa (update_ids_from_dap may be unused)
        """
...
class RestartFrameArguments(BaseSchema):
    ...
    __props__ = {
        "frameId": {"type": "integer", "description": "Restart this stackframe."}
    }
    __refs__ = set()
...
class ModulesViewDescriptor(BaseSchema):
    ...
    def __init__(
        self, columns, update_ids_from_dap=False, **kwargs
    ):  # noqa (update_ids_from_dap may be unused)
        """
        :param array columns:
        """
    ...
    def to_dict(
        ...
        dct = {
            "columns": [ColumnDescriptor.update_dict_ids_to_dap(o) for o in columns]
            if (update_ids_to_dap and columns)
            else columns,
        }
        dct.update(self.kwargs)
        return dct
...
class Thread(BaseSchema):
    ...
    __props__ = {
        ...
        "name": {"type": "string", "description": "A name of the thread."},
    }
    __refs__ = set()
...
class Scope(BaseSchema):
    ...
    __props__ = {
        ...
        "source": {"description": "Optional source for this scope.", "type": "Source"},
        "line": {
            "type": "integer",
...
class StepInTarget(BaseSchema):
    ...
    def __init__(
        self, id, label, update_ids_from_dap=False, **kwargs
    ):  # noqa (update_ids_from_dap may be unused)
        """
...
class Checksum(BaseSchema):
    ...
    __props__ = {
        ...
        "checksum": {"type": "string", "description": "Value of the checksum."},
    }
...
class ScopesResponseBody(BaseSchema):
    ...
    def to_dict(
        ...
        dct = {
            "scopes": [Scope.update_dict_ids_to_dap(o) for o in scopes]
...
class VariablesResponseBody(BaseSchema):
    ...
    def to_dict(
        ...
        dct = {
            "variables": [Variable.update_dict_ids_to_dap(o) for o in variables]
...
class ThreadsResponseBody(BaseSchema):
    ...
    def to_dict(
        ...
        dct = {
            "threads": [Thread.update_dict_ids_to_dap(o) for o in threads]
...
class ModulesResponseBody(BaseSchema):
    ...
    def to_dict(
        ...
        dct = {
            "modules": [Module.update_dict_ids_to_dap(o) for o in modules]
...
class LoadedSourcesResponseBody(BaseSchema):
    ...
    def to_dict(
        ...
        if sources and hasattr(sources[0], "to_dict"):
            sources = [x.to_dict() for x in sources]
        dct = {
            "sources": [Source.update_dict_ids_to_dap(o) for o in sources]
            if (update_ids_to_dap and sources)
            else sources,
        }
        dct.update(self.kwargs)
...
class StepInTargetsResponseBody(BaseSchema):
    ...
    def to_dict(
        ...
        dct = {
            "targets": [StepInTarget.update_dict_ids_to_dap(o) for o in targets]
...
class GotoTargetsResponseBody(BaseSchema):
    ...
    def to_dict(
        ...
        if targets and hasattr(targets[0], "to_dict"):
            targets = [x.to_dict() for x in targets]
        dct = {
            "targets": [GotoTarget.update_dict_ids_to_dap(o) for o in targets]
            if (update_ids_to_dap and targets)
            else targets,
        }
        dct.update(self.kwargs)
...
class CompletionsResponseBody(BaseSchema):
    ...
    def to_dict(
        ...
        if targets and hasattr(targets[0], "to_dict"):
            targets = [x.to_dict() for x in targets]
        dct = {
            "targets": [CompletionItem.update_dict_ids_to_dap(o) for o in targets]
            if (update_ids_to_dap and targets)
            else targets,
        }
        dct.update(self.kwargs)
...
class DisassembleResponseBody(BaseSchema):
    ...
    def to_dict(
        ...
        dct = {
            "instructions": [
                DisassembledInstruction.update_dict_ids_to_dap(o) for o in instructions
            ]
