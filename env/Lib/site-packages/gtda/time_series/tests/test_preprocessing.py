...
signal_resampled_4 = np.array([2.0, 2.90929743, 1.2431975, 1.7205845, 2.98935825])
...
@pytest.mark.parametrize(
    "period, expected", [(2, signal_resampled_2), (4, signal_resampled_4)]
)
...
@pytest.mark.parametrize(
    "operation, expected", [("return", signal_stationarized_return)]
)
