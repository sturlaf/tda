...
def test_trivial_two_point_diagram_1():
    ...
    assert (correct_answer * delta) <= (
        bottleneck_distance(diagram_a, diagram_b, delta) - 0.5
    )
    assert (correct_answer * delta) <= (
        bottleneck_distance(diagram_b, diagram_a, delta) - 0.5
    )
...
def test_inf_3():
    ...
    assert (correct_answer) == (bottleneck_distance(diagram_a, diagram_b, delta))
    assert (correct_answer) == (bottleneck_distance(diagram_b, diagram_a, delta))
