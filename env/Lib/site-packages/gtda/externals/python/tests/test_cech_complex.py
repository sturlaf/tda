...
def test_example_from_points():
    ...
    points.append([0.0, 1.0])  # 1
    points.append([2.0, 1.0])  # 2
    points.append([3.0, 2.0])  # 3
    points.append([0.0, 3.0])  # 4
    points.append([3.0 + sqrt(3.0), 3.0])  # 5
    points.append([1.0, 4.0])  # 6
    points.append([3.0, 4.0])  # 7
    points.append([2.0, 4.0 + sqrt(3.0)])  # 8
    points.append([0.0, 4.0])  # 9
    points.append([-0.5, 2.0])  # 10
