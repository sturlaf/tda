...
class SimplexTree:
    ...
    def insert(self, simplex, filtration=0.0):
        ...
        """
        csimplex = [i for i in simplex]
        return self.thisptr.insert_simplex_and_subfaces(csimplex, filtration)
    ...
    def persistence(
        ...
        if self.pcohptr is not None:
            del self.pcohptr
        self.pcohptr = Simplex_tree_persistence_interface(
            self.thisptr, persistence_dim_max
        )
        persistence_result = []
        if self.pcohptr is not None:
    ...
    def betti_numbers(self):
        ...
        if self.pcohptr is not None:
            ...
            print(
                "`betti_numbers` requires persistence function to be " "launched first."
            )
        return bn_result
    ...
    def persistent_betti_numbers(self, from_value, to_value):
        ...
        if self.pcohptr is not None:
            ...
            print(
                "`persistent_betti_numbers` requires persistence function "
    ...
    def persistence_intervals_in_dimension(self, dimension):
        ...
        if self.pcohptr is not None:
            ...
            print(
                "`intervals_in_dim` requires persistence function to be "
                "launched first."
            )
    ...
    def persistence_pairs(self):
        ...
        if self.pcohptr is not None:
            ...
            print(
                "`persistence_pairs` requires persistence function to be "
                "launched first."
            )
