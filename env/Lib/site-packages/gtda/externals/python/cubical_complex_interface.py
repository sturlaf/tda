import os
import numpy as np
from ..modules.gtda_cubical_complex import (
    Cubical_complex_interface as Bitmap_cubical_complex_base_interface,
)
from ..modules.gtda_persistent_cohomology import (
    Persistent_cohomology_interface as Cubical_complex_persistence_interface,
)
...
class CubicalComplex:
    ...
    def __init__(self, dimensions=None, top_dimensional_cells=None, perseus_file=""):
        ...
        if (
            ...
            and (top_dimensional_cells is not None)
            and (perseus_file == "")
        ):
            ...
            (dimensions is None)
            and (top_dimensional_cells is None)
            and (perseus_file != "")
        ):
    ...
    def persistence(self, homology_coeff_field=11, min_persistence=0):
        ...
        if self.thisptr is not None:
            pass
            self.pcohptr = Cubical_complex_persistence_interface(self.thisptr, True)
        persistence_result = []
        if self.pcohptr is not None:
    ...
    def persistence_intervals_in_dimension(self, dimension):
        ...
        if self.pcohptr is not None:
            ...
            print(
                "intervals_in_dim function requires persistence function"
