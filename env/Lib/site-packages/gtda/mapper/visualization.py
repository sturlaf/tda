...
def plot_static_mapper_graph(
    ...
    edge_trace, node_trace, node_colors_color_features = _calculate_graph_data(
        graph,
        color_data_transformed,
        node_color_statistic,
        layout,
...
class MapperInteractivePlotter:
    ...
    def plot(
        ...
        logs_box = widgets.Checkbox(
            description="Show logs: ", value=False, indent=False
        )
        ...
        if layout_dim == 3:
            ...
            # colorscale.
            is_bgcolor_not_white = self._figure.data[1].hoverlabel.bgcolor != "white"
            ...
            if is_bgcolor_not_white and not user_hoverlabel_bgcolor:
                colorscale_for_hoverlabel = self._figure.data[1].marker.colorscale
        ...
        box = widgets.VBox([container_parameters, self._figure, valid, logs_box, out])
