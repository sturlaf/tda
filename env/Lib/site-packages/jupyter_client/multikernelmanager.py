...
def kernel_method(f: t.Callable) -> t.Callable:
    ...
    def wrapped(
        self, kernel_id: str, *args, **kwargs
...
class MultiKernelManager(LoggingConfigurable):
    ...
    async def _async_start_kernel(
        self, kernel_name: t.Optional[str] = None, **kwargs
    ) -> str:
        """Start a new kernel.
        ...
        fut = asyncio.ensure_future(
            self._add_kernel_when_ready(
                kernel_id, km, ensure_async(km.start_kernel(**kwargs))
            )
        )
    ...
    def request_shutdown(
        self, kernel_id: str, restart: t.Optional[bool] = False
    ) -> None:
