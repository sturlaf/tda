...
ws.cells.append(new_heading_cell(u"My Heading", level=2))
...
ws.cells.append(
    new_code_cell(
        ...
        outputs=[
            ...
            new_output(output_type=u"stream", output_text="foo\rbar\r\n"),
            new_output(
                output_type=u"stream", stream="stderr", output_text="\rfoo\rbar\n"
            ),
        ],
    )
)
...
authors = [
    new_author(
        ...
        affiliation=u"Fox",
        url=u"http://www.fox.com",
    )
]
md = new_metadata(
    name=u"My Notebook",
    license=u"BSD",
    created=u"8601_goes_here",
    modified=u"8601_goes_here",
    gistid=u"21341231",
    authors=authors,
)
