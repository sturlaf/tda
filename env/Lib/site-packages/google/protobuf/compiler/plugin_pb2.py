...
_CODEGENERATORRESPONSE_FILE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.protobuf.compiler.CodeGeneratorResponse.File.generated_code_info",
            index=3,
            number=16,
            type=11,
            cpp_type=10,
...
_CODEGENERATORREQUEST.fields_by_name[
    "proto_file"
].message_type = google_dot_protobuf_dot_descriptor__pb2._FILEDESCRIPTORPROTO
_CODEGENERATORREQUEST.fields_by_name["compiler_version"].message_type = _VERSION
_CODEGENERATORRESPONSE_FILE.fields_by_name[
    "generated_code_info"
].message_type = google_dot_protobuf_dot_descriptor__pb2._GENERATEDCODEINFO
