...
class Checkbox(_Bool):
    ...
    indent = Bool(
        True, help="Indent the control to align with other controls with a description."
    ).tag(sync=True)
...
class Valid(_Bool):
    ...
    readout = Unicode("Invalid", help="Message displayed when the value is False").tag(
        sync=True
    )
