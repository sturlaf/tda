...
class DescriptionWidget(DOMWidget, CoreWidget):
    ...
    description_tooltip = Unicode(
        None,
        allow_none=True,
        help="Tooltip for the description (defaults to description).",
    ).tag(sync=True)
    style = InstanceDict(DescriptionStyle, help="Styling customizations").tag(
