...
class TestTwoByTwoLayout(TestCase):
    ...
    def test_merge_cells(self):  # pylint: disable=no-self-use
        ...
        box = widgets.TwoByTwoLayout(
            top_left=button1, top_right=button2, bottom_left=None, bottom_right=button4
        )
        ...
        box = widgets.TwoByTwoLayout(
            top_left=None, top_right=button2, bottom_left=button3, bottom_right=button4
        )
        ...
        box = widgets.TwoByTwoLayout(
            top_left=None, top_right=button2, bottom_left=None, bottom_right=button4
        )
        ...
        box = widgets.TwoByTwoLayout(
            top_left=button1, top_right=None, bottom_left=button3, bottom_right=button4
        )
        ...
        box = widgets.TwoByTwoLayout(
            top_left=button1, top_right=None, bottom_left=None, bottom_right=None
        )
        ...
        box = widgets.TwoByTwoLayout(
            top_left=None, top_right=button1, bottom_left=None, bottom_right=None
        )
    ...
    def test_pass_layout_options(self):  # pylint: disable=no-self-use
        ...
        layout = widgets.Layout(
            grid_gap="10px", justify_content="center", align_items="center"
        )
        box = widgets.TwoByTwoLayout(
            top_left=button1,
            top_right=button2,
    ...
    def test_update_dynamically(self, send_state):  # pylint: disable=no-self-use
        ...
        box = widgets.TwoByTwoLayout(
            top_left=button1, top_right=button3, bottom_left=None, bottom_right=button4
        )
...
class TestAppLayout(TestCase):
    ...
    def test_merge_empty_cells(self):
        ...
        box = widgets.AppLayout(
            header=header, footer=footer, left_sidebar=left_sidebar, center=center
        )
        ...
        box = widgets.AppLayout(
            header=header, footer=footer, right_sidebar=right_sidebar, center=center
        )
        ...
        box = widgets.AppLayout(
            header=header, footer=footer, center=center, merge=False
        )
        ...
        box = widgets.AppLayout(
            center=center, left_sidebar=left_sidebar, right_sidebar=right_sidebar
        )
...
class TestGridspecLayout(TestCase):
    ...
    def test_setitem_index(self):
        ...
        assert box.layout.grid_template_areas == '''"{b1} . ."\n"{b3} . {b2}"'''.format(
            b1=button1_label, b2=button2_label, b3=button3_label
        )
        ...
        assert box.layout.grid_template_areas == '''"{b1} . ."\n"{b4} . {b2}"'''.format(
            b1=button1_label, b2=button2_label, b4=button4_label
        )
    ...
    def test_setitem_slices(self):
        ...
        assert (
            box.layout.grid_template_areas
