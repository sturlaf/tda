...
class Debugger:
    ...
    static_debug_msg_types = ["debugInfo", "inspectVariables", "richInspectVariables"]
    ...
    async def richInspectVariables(self, message):
        ...
        if not self.breakpoint_list:
            ...
            var_repr_data, var_repr_metadata = get_ipython().display_formatter.format(
                var_name
            )
        else:
            ...
            request = {
                ...
                "seq": seq + 1,
                "arguments": {"expression": lvalue, "value": code, "frameId": frame_id},
            }
