...
def charmap_decode(
    data: _Decodable, errors: _Errors = ..., mapping: Optional[_MapT] = ...
) -> Tuple[Text, int]: ...
def charmap_encode(
    data: _Encodable, errors: _Errors, mapping: Optional[_MapT] = ...
) -> Tuple[bytes, int]: ...
...
def raw_unicode_escape_decode(
    data: _String, errors: _Errors = ...
) -> Tuple[Text, int]: ...
def raw_unicode_escape_encode(
    data: _Encodable, errors: _Errors = ...
) -> Tuple[bytes, int]: ...
...
def utf_16_be_decode(
    data: _Decodable, errors: _Errors = ..., final: int = ...
) -> Tuple[Text, int]: ...
...
def utf_16_encode(
    data: _Encodable, errors: _Errors = ..., byteorder: int = ...
) -> Tuple[bytes, int]: ...
...
if sys.platform == "win32":
    ...
    if sys.version_info >= (3, 0):
        def oem_decode(
            data: bytes, errors: _Errors = ..., final: int = ...
        ) -> Tuple[Text, int]: ...
        def code_page_decode(
            codepage: int, data: bytes, errors: _Errors = ..., final: int = ...
        ) -> Tuple[Text, int]: ...
        def oem_encode(str: Text, errors: _Errors = ...) -> Tuple[bytes, int]: ...
        def code_page_encode(
            code_page: int, str: Text, errors: _Errors = ...
        ) -> Tuple[bytes, int]: ...
